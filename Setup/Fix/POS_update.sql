...
IF NOT EXISTS (SELECT 1 FROM PAYMENTGATEWAYINFO WHERE PAYMENTGATEWAYINFONAME = 'PineLabs-Victory')
BEGIN
	INSERT INTO PAYMENTGATEWAYINFO(PAYMENTGATEWAYINFOID, PAYMENTGATEWAYINFONAME, PAYMENTGATEWAYCONFIGDATA, PAYMENTGATEWAYINFOTYPE, CREATEDBY, CREATEDDATE)
	SELECT 1, 'PineLabs-Victory'
	, ' { "MerchantID": "29895", "SecurityToken" : "08b1b2ff-6d0d-4611-a757-394b6972f080", "AutoCancelDurationInMinutes" : "0", "PaymentURL" : "https://instore-ism.uat.pinelabs.com/api/CloudBasedIntegration/V1/" }'
	, 'PineLabs', 4, GETDATE()
END
GO
