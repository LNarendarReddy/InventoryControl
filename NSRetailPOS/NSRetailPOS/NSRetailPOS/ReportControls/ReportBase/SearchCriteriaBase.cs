...
namespace NSRetail
{
    public partial class SearchCriteriaBase : XtraUserControl
    {
        ...
        protected IEnumerable<string> AllowedRoles 
        {
            ...
            {
                allowedRoles = value;
                HasAccess = true; //Utility.Role == "Admin" || Utility.Role == "IT Manager" || (AllowedRoles != null && AllowedRoles.Contains(Utility.Role));
            }
        }
        ...
        public object GetReportData(string procName, Dictionary<string, object> parameters, bool useCloudConn = false)
        {
            ...
            try
            {
                ...
                reportData = IsDataSet ? 
                    ...
                    : reportRepository.GetReportData(procName, parameters);
        ...
        {            
            ...
            dataTable.Columns.Add("BRANCHID");
            dataTable.Columns.Add("BRANCHNAME");
            dataTable.Rows.Add(Utility.branchInfo.BranchID, Utility.branchInfo.BranchName);

            cmb.Properties.DataSource = dataTable;
        ...
        public void BindItemCode(Control cntrl)
        {
            ...
            cmb.Properties.DataSource = new ItemRepository().GetItemCodes();
