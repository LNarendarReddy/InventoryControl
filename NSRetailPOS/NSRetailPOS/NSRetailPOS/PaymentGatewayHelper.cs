...
namespace NSRetailPOS
{
    ...
    public class BasePaylod
    {
        public string ClientID
        {
            get { return GatewayInfo.ClientID; }
            private set;
        }
        public string MerchantID
        {
            get { return GatewayInfo.MerchantID; }
            private set;
        }
        public string StoreID
        {
            get { return GatewayInfo.StoreID; }
            private set;
        }
        public string SecurityToken
        {
            get { return GatewayInfo.SecurityToken; }
            private set;
        }
    }

    public class RequestPayload : BasePaylod
    {
        ...
        {
            get { return Convert.ToString(Utility.loginInfo.UserFullName); }
            private set; 
        }
        public int AutoCancelDurationInMinutes
        {
            get { return GatewayInfo.AutoCancelDurationInMinutes; }
            private set;
        }
    }

    public class StatusPayload : BasePaylod
    {
        public int PlutusTransactionReferenceID { get; set; }
    }
    public class CancelPayload : StatusPayload
    {
        public int Amount { get; set; }
    }

    public class BillingUploadResponse
    {
