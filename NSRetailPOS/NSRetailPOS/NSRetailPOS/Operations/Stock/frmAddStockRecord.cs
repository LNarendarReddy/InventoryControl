...
namespace NSRetailPOS.Operations.Stock
{
    public partial class frmAddStockRecord : XtraForm
    {
        ...
        private void frmAddStockRecord_Load(object sender, EventArgs e)
        {
            try
            {
                ((frmOpetations)frmparent.MdiParent).RefreshBaseLineData += FrmStockDispatch_RefreshBaseLineData;

                txtQuantity.ConfirmLargeNumber();
                txtMRP.ConfirmLargeNumber();
        ...
        private void btnSave_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                ObjStockEntryDetail.UserID = Utility.loginInfo.UserID;
