    ...
    public partial class frmItemCodeList : DevExpress.XtraEditors.XtraForm
    {
        ...
        private void btnDelete_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    new ItemCodeRepository().DeleteItemCode(gvItemList.GetFocusedRowCellValue("ITEMCODEID"), Utility.loginInfo.UserID);
        ...
        private void frmItemList_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                ((frmOpetations)this.MdiParent).RefreshBaseLineData += FrmItemCodeList_RefreshBaseLineData;
            }
            catch (Exception ex)
            {
                XtraMessageBox.Show(ex.Message);
