...
namespace NSRetailPOS.Operations.Items
{
    public partial class frmItemCode : DevExpress.XtraEditors.XtraForm
    {
        ...
        private void frmItem_Load(object sender, EventArgs e)
        {
            ...
            btnSave.Enabled = Utility.loginInfo.RoleName != "Division Manager" && Utility.loginInfo.RoleName != "Division User";
        ...
        private void btnSave_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                itemObj.UserID = Utility.loginInfo.UserID;
                ...
                else
                {
                    ...
                    drNewItemCode["CREATEDBY"] = Utility.loginInfo.UserFullName;
        ...
        private void txtItemCode_Properties_Leave(object sender, EventArgs e)
        {
            ...
            DataSet dsItemDetails = new ItemCodeRepository().GetItemCode(itemObj.ItemCodeID, Utility.loginInfo.CategoryID);
            ...
            {
                frmMRPList frmMRPList = new frmMRPList(dtItemCodePrices, itemObj.ItemCodeID, showCostPrice: false);
