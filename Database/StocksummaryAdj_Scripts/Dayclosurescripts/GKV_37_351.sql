...
(
	...
	WHERE PBD.BRANCHCOUNTERID = 37 AND PBD.DAYCLOSUREID = 351 AND PB.BILLSTATUS = 1 AND PBD.DELETEDDATE IS NULL
...
CREATE TABLE #Ledger(TRANSACTIONID INT, TRANSACTIONDATE DATE, CREDIT DECIMAL(18,2), DEBIT DECIMAL(18,2), TRANSACTIONTYPE VARCHAR(50), BRANCHNAME VARCHAR(100), RUNNINGBAL DECIMAL(18,2), SKUCODE VARCHAR(10), ITEMNAME VARCHAR(100))

DECLARE @ITEMID INT, @BRANCHID INT = 80, @COUNT INT = 1
