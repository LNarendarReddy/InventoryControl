...
(
	...
	WHERE PBD.BRANCHCOUNTERID = 98 AND PBD.DAYCLOSUREID in(2299,2300) AND PB.BILLSTATUS = 1 AND PBD.DELETEDDATE IS NULL
...
DECLARE @ITEMID INT, @BRANCHID INT = 53, @COUNT INT = 1
