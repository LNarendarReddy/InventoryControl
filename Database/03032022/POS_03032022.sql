...
END
GO
ALTER PROCEDURE [dbo].[POS_USP_R_POSDETAILS]    
AS    
BEGIN    
    
SELECT POS.BRANCHID,BRANCHCOUNTERID,  
B.BRANCHNAME,BC.COUNTERNAME FROM POS_POSDETAILS  POS  
INNER JOIN POS_BRANCH B ON POS.BRANCHID = B.BRANCHID  
INNER JOIN POS_BRANCHCOUNTER BC ON POS.BRANCHCOUNTERID = BC.COUNTERID  
