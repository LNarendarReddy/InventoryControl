...
ALTER TABLE BRANCHCOUNTER ALTER COLUMN HDDSNO VARCHAR(40)
...
UPDATE ITEM SET SYNCDATE = GETUTCDATE() + '05:30'
UPDATE ITEMCODE SET SYNCDATE = GETUTCDATE() + '05:30'
UPDATE ITEMPRICE SET SYNCDATE = GETUTCDATE() + '05:30'
UPDATE STOCKDISPATCH SET SYNCDATE = GETUTCDATE() + '05:30'
UPDATE STOCKDISPATCHDETAIL SET SYNCDATE = GETUTCDATE() + '05:30'
UPDATE TBLMOP SET SYNCDATE = GETUTCDATE() + '05:30'
UPDATE TBLUSER SET SYNCDATE = GETUTCDATE() + '05:30'
UPDATE UOM SET SYNCDATE = GETUTCDATE() + '05:30'
UPDATE POS_DENOMINATION SET SYNCDATE = GETUTCDATE() + '05:30'
UPDATE ITEMGROUP SET SYNCDATE = GETUTCDATE() + '05:30'
UPDATE ITEMGROUPDETAIL SET SYNCDATE = GETUTCDATE() + '05:30'
UPDATE OFFER SET SYNCDATE = GETUTCDATE() + '05:30'
UPDATE OFFERBRANCH SET SYNCDATE = GETUTCDATE() + '05:30'
UPDATE OFFERITEMMAP SET SYNCDATE = GETUTCDATE() + '05:30'
UPDATE OFFERTYPE SET SYNCDATE = GETUTCDATE() + '05:30'
UPDATE POS_DAYSEQUENCE SET SYNCDATE = GETUTCDATE() + '05:30'
UPDATE POS_BILLMOPDETAIL SET SYNCDATE = GETUTCDATE() + '05:30'
UPDATE POS_BREFUNDDETAIL SET SYNCDATE = GETUTCDATE() + '05:30'
UPDATE POS_DAYCLOSUREDETAIL SET SYNCDATE = GETUTCDATE() + '05:30'
UPDATE POS_BILLDETAIL SET SYNCDATE = GETUTCDATE() + '05:30'
UPDATE TBLCATEGORY SET SYNCDATE = GETUTCDATE() + '05:30'
UPDATE POS_CREFUND SET SYNCDATE = GETUTCDATE() + '05:30'
UPDATE POS_DAYCLOSURE SET SYNCDATE = GETUTCDATE() + '05:30'
UPDATE POS_BILL SET SYNCDATE = GETUTCDATE() + '05:30'
UPDATE BRANCH SET SYNCDATE = GETUTCDATE() + '05:30'
UPDATE BRANCHCOUNTER SET SYNCDATE = GETUTCDATE() + '05:30'
UPDATE GSTDETAIL SET SYNCDATE = GETUTCDATE() + '05:30'
GO
...
BEGIN
	...
	SELECT BRANCHID, BRANCHNAME, BRANCHCODE, ADDRESS, PHONENO, LANDLINE, EMAILID, SUPERVISORID, ISWAREHOUSE, CREATEDDATE, UPDATEDATE, DELETEDDATE, STATEID, GETUTCDATE() + '05:30' FROM @Branches UB
...
BEGIN
	...
	SELECT COUNTERID, COUNTERNAME, BRANCHID, CREATEDDATE, UPDATEDDATE, DELETEDDATE
		, DAYCLOSUREID, BRANCHREFUNDID, GETUTCDATE() + '05:30'
...
, DEN.SYNCDATE = GETUTCDATE() + '05:30'
 ...
 SELECT DENOMINATIONID,DISPLAYVALUE,MULTIPLIER,CREATEDDATE,UPDATEDDATE, GETUTCDATE() + '05:30' FROM @Denomination  DEN
...
BEGIN
	...
	SELECT GSTID, GSTCODE, CGST, SGST, IGST, CESS, CREATEDDATE, UPDATEDATE, DELETEDDATE, GETUTCDATE() + '05:30'
...
BEGIN 
	...
	SELECT ITEMID, SKUCODE, ITEMNAME, CREATEDDATE, UPDATEDATE, DELETEDDATE, ISOPENITEM, PARENTITEMID, UOMID, CATEGORYID, GETUTCDATE() + '05:30'
...
BEGIN
	...
	SELECT ITEMCODEID, ITEMID, ITEMCODE, CREATEDDATE, UPDATEDATE, DELETEDDATE, FREEITEMCODEID, HSNCODE, GETUTCDATE() + '05:30'
...
BEGIN
	...
	SELECT ITEMGROUPID, GROUPNAME, ISACTIVE, CREATEDDATE, UPDATEDDATE, DELETEDDATE, GETUTCDATE() + '05:30'
	FROM @ItemGroups UIG
	WHERE NOT EXISTS 
		(
...
BEGIN
	...
	SELECT ITEMGROUPDETAILID, ITEMGROUPID, ITEMCODEID, CREATEDDATE, DELETEDDATE, GETUTCDATE() + '05:30'
...
BEGIN
	...
	SELECT ITEMPRICEID, ITEMCODEID, SALEPRICE, MRP, GSTID, CREATEDDATE, UPDATEDATE, DELETEDDATE, GETUTCDATE() + '05:30' FROM @ItemPrices UIP
	WHERE NOT EXISTS
		(
...
BEGIN
	...
	SELECT OFFERID, OFFERNAME, OFFERCODE, STARTDATE, ENDDATE, OFFERVALUE, OFFERTYPEID, CATEGORYID
		, ITEMGROUPID, CREATEDDATE, UPDATEDDATE, DELETEDDATE, ISACTIVE, APPLIESTOID, GETUTCDATE() + '05:30'
	FROM @Offers UOFR
	WHERE NOT EXISTS 
		(
...
BEGIN
	...
	SET
		...
		, OFRB.SYNCDATE = GETUTCDATE() + '05:30'
	FROM					  
		OFFERBRANCH OFRB
	...
	SELECT OFFERBRANCHID, OFFERID, BRANCHID, CREATEDDATE, DELETEDDATE, GETUTCDATE() + '05:30'
...
BEGIN
	...
	SET
		...
		, OFRIM.SYNCDATE	 = GETUTCDATE() + '05:30'
	FROM					  
		OFFERITEMMAP OFRIM
	...
	SELECT OFFERITEMMAPID, OFFERID, ITEMCODEID, CREATEDDATE, DELETEDDATE, GETUTCDATE() + '05:30'
...
BEGIN
	...
	SET
		...
		, OFRT.SYNCDATE			 = GETUTCDATE() + '05:30'
	FROM					  
		OFFERTYPE OFRT
	...
	SELECT OFFERTYPEID, OFFERTYPENAME, OFFERTYPECODE, BUYQUANTITY, FREEQUANTITY, GETUTCDATE() + '05:30'
...
BEGIN        
 ...
 QUANTITY, WEIGHTINKGS, BILLEDAMOUNT, CREATEDDATE, UPDATEDDATE, DELETEDDATE        
  , CGST, SGST, IGST, CESS, GSTVALUE, GSTID, SNO, DISCOUNT ,OFFERID,DAYCLOSUREID, GETUTCDATE() + '05:30'      
...
CREATEDDATE,UPDATEDDATE,@BranchCounterID,DAYCLOSUREID, GETUTCDATE() + '05:30'
...
UPDATEDDATE,DELETEDBY,DELETEDDATE,STATUS,BREFUNDNUMBER,@BranchCounterID, GETUTCDATE() + '05:30'    
...
REFUNDAMOUNT,CREATEDBY,CREATEDDATE,UPDATEDBY,UPDATEDDATE,DELETEDBY,  
DELETEDDATE,DAYCLOSUREID,@BranchCounterID, GETUTCDATE() + '05:30'
...
, DCD.SYNCDATE = GETUTCDATE() + '05:30'
 ...
 SELECT DAYCLOSUREDETAILID,DAYCLOSUREID,DENOMINATIONID,CLOSUREVALUE,      
  MOPID,CREATEDDATE,UPDATEDDATE,@BranchCounterID, GETUTCDATE() + '05:30'   
 ...
 FROM         
  ...
  AND UDS.BRANCHCOUNTERID = DS.BRANCHCOUNTERID      
	...
	SELECT OPENDATE, LASTUSEDBILLNUM, ISCLOSED, BRANCHCOUNTERID, LASTBILLID, DAYSEQUENCEID
		, OPENBILLID, CREATEDATE, UPDATEDATE, GETUTCDATE() + '05:30'
...
BEGIN
	...
	SELECT STOCKDISPATCHID, FROMBRANCHID, TOBRANCHID, STATUS, STATUSAPPROVEDBY, STATUSAPPROVEDDATE, CREATEDDATE, UPDATEDATE, DELETEDDATE, DISPATCHNUMBER
		, CREATEDBY, UPDATEDBY, DELETEDBY, GETUTCDATE() + '05:30'
...
BEGIN    
 ...
 DISPATCHQUANTITY, RECEIVEDQUANTITY, WEIGHTINKGS, CREATEDDATE    
   , UPDATEDATE, DELETEDDATE  ,ISACCEPTED, GETUTCDATE() + '05:30'
...
CAT.CREATEDBY  = UCAT.CREATEDBY   ,
CAT.CREATEDDATE = UCAT.CREATEDDATE   ,
CAT.UPDATEDBY = UCAT.UPDATEDBY   ,
CAT.UPDATEDDATE = UCAT.UPDATEDDATE  , 
CAT.DELETEDBY = UCAT.CATEGORYNAME   ,
CAT.DELETEDDATE = UCAT.DELETEDDATE  , 
CAT.ALLOWOPENITEMS = UCAT.ALLOWOPENITEMS   
, CAT.SYNCDATE = GETUTCDATE() + '05:30'
 FROM    
  TBLCATEGORY CAT  
...
,CREATEDDATE,UPDATEDBY,UPDATEDDATE
,DELETEDBY,DELETEDDATE,ALLOWOPENITEMS, GETUTCDATE() + '05:30'
FROM @Category  Cat  
...
BEGIN
	...
	SELECT UOMID, DISPLAYVALUE, BASEUOMID, MULTIPLIER, CREATEDDATE, UPDATEDDATE, DELETEDDATE, GETUTCDATE() + '05:30'  FROM @UOM UU
...
BEGIN
	...
	SELECT USERID, ROLEID, REPORTINGLEADID, CATEGORYID, BRANCHID, USERNAME, PASSWORDSTRING, FULLNAME, CNUMBER, EMAIL, ISOTP, GENDER, DOB, CREATEDDATE, UPDATEDDATE, DELETEDDATE, GETUTCDATE() + '05:30' FROM @User UR
