...
UPDATE ITEM SET SYNCDATE = GETDATE()
UPDATE ITEMCODE SET SYNCDATE = GETDATE()
UPDATE ITEMPRICE SET SYNCDATE = GETDATE()
UPDATE STOCKDISPATCH SET SYNCDATE = GETDATE()
UPDATE STOCKDISPATCHDETAIL SET SYNCDATE = GETDATE()
UPDATE TBLMOP SET SYNCDATE = GETDATE()
UPDATE TBLUSER SET SYNCDATE = GETDATE()
UPDATE UOM SET SYNCDATE = GETDATE()
UPDATE POS_DENOMINATION SET SYNCDATE = GETDATE()
UPDATE ITEMGROUP SET SYNCDATE = GETDATE()
UPDATE ITEMGROUPDETAIL SET SYNCDATE = GETDATE()
UPDATE OFFER SET SYNCDATE = GETDATE()
UPDATE OFFERBRANCH SET SYNCDATE = GETDATE()
UPDATE OFFERITEMMAP SET SYNCDATE = GETDATE()
UPDATE OFFERTYPE SET SYNCDATE = GETDATE()
UPDATE POS_DAYSEQUENCE SET SYNCDATE = GETDATE()
UPDATE POS_BILLMOPDETAIL SET SYNCDATE = GETDATE()
UPDATE POS_BREFUNDDETAIL SET SYNCDATE = GETDATE()
UPDATE POS_DAYCLOSUREDETAIL SET SYNCDATE = GETDATE()
UPDATE POS_BILLDETAIL SET SYNCDATE = GETDATE()
UPDATE TBLCATEGORY SET SYNCDATE = GETDATE()
UPDATE POS_CREFUND SET SYNCDATE = GETDATE()
UPDATE POS_DAYCLOSURE SET SYNCDATE = GETDATE()
UPDATE POS_BILL SET SYNCDATE = GETDATE()
UPDATE BRANCH SET SYNCDATE = GETDATE()
UPDATE BRANCHCOUNTER SET SYNCDATE = GETDATE()
UPDATE GSTDETAIL SET SYNCDATE = GETDATE()
GO
