...
INSERT INTO #Summary 
select I.ITEMID,I.SKUCODE,I.ITEMNAME, SUM(CAST(SSL.OLDQTY AS decimal(18,2)) - CAST(SSL.QUANTITY AS decimal(18,2))) AS DIFF, 0 AS LEDGERQUANTITY, 0 AS LEDGERWEIGHTINKGS, 0 AS ISPROCESSED, I.ISOPENITEM, 0 AS SSQUANTITY, 0 AS SSWEIGHTINKGS
...
DECLARE @ITEMID INT, @BRANCHID INT = 48, @COUNT INT = 1
...
BEGIN  
	...
	INSERT INTO #Ledger
	EXEC USP_RPT_ITEMLEDGER1 @ItemID = @ITEMID, @FromDate ='2023-03-14', @ToDate = '2023-04-18', @BranchID = @BRANCHID
