...
WHERE SS.BRANCHID = 47 and (SSL.CREATEDDATE = '2023-03-21 10:01:33.817' OR SSL.CREATEDDATE = '2023-03-31 21:22:41.340') and ssl.ttype = 'BS'
...
DECLARE @ITEMID INT, @BRANCHID INT = 47, @COUNT INT = 1
...
BEGIN  
	...
	INSERT INTO #Ledger
	EXEC USP_RPT_ITEMLEDGER1 @ItemID = @ITEMID, @FromDate ='2023-03-16', @ToDate = '2023-04-18', @BranchID = @BRANCHID
