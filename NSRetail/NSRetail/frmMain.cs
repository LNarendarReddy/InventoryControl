...
namespace NSRetail
{
    public partial class frmMain : RibbonForm
    {
        ...
        private void bbiBranchReports_ItemClick_1(object sender, ItemClickEventArgs e)
        {
            ...
            POSReports.SubCategory.Add(new ReportHolder() { ReportName = "Customer Refunds By Bill #", SearchCriteriaControl = new ucCRefundSheets() });
        ...
        private void bbiSupplierReports_ItemClick(object sender, ItemClickEventArgs e)
        {
            ...
            ReportHolder supplierwisereports = new ReportHolder() { ReportName = "Supplier Wise Reports(Not Accurate)" };
