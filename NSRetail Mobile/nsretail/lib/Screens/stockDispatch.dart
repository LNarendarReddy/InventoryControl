...
class _stockDispatchListState extends State<stockDispatchList> {
  ...
  final String url =
      'http://43.228.95.51/nsretailapi/api/stockdispatch?stockcountdetailid=';
  ...
  void updateStatus() async {
    ...
    try {
      ...
      final response = await http.post(
          Uri.parse(
              "http://43.228.95.51/nsretailapi/api/stockdispatch/UpdateStatus/" +
                  stockCountingId),
          headers: {"Authorization": "Bearer $value"});
              ...
              trailing: IconButton(
                ...
                onPressed: () async {
                  try {
                    ...
                    final response = await http.post(
                        Uri.parse(
                            "http://43.228.95.51/nsretailapi/api/stockdispatch/DeleteStockCounting/" +
        ...
        child: IconButton(
          ...
          onPressed: () {
            Navigator.push(
              ...
              MaterialPageRoute(
                builder: (context) =>
                    StockDispatchItem(widget.branchId, nStockcountingID),
              ),
            ).then((value) => setState(() {
              this.getData();
            }));
